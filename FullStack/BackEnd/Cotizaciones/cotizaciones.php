<?php
  require_once("../Login/LoginEmpleados.php");
  session_start();
        ...
        <table class="table table-custom ">
          ...
          <tbody class="" id="tabla">
            ...
            <tr>
              ...
              <td><?php echo $val['idEmpleados'] ?></td>
              <td><?php echo $val['Constructora'] ?></td>
              <td><?php echo $val['Fecha'] ?></td>
              <td>  
                <a class="btn btn-danger" href="borrarCotizaciones.php?idCotizacion=<?=$val['idCotizacion']?>&req=delete">Borrar</a>
              </td>
              <td>
                <a class="btn btn-warning" href="editarCotizaciones.php?idCotizacion=<?=$val['idCotizacion']?>">Editar</a>
              </td>
            </tr>
          </tbody>
        <?php
